...
public static class SerilogConfiguration
{
    ...
    public static IServiceCollection AddSerilogConfiguration(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        if (logSettings.GetValue("EnableConsoleLogging", true))
        {
            if (logSettings.GetValue("UseCompactJsonConsoleLogging", false))
            {
        ...
        if (logSettings.GetValue("EnableFileLogging", true) && !string.IsNullOrEmpty(logPath))
        {
            if (logSettings.GetValue("UseCompactJsonFileLogging", false))
            {
